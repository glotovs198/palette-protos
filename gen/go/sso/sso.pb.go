...
type RegiterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of registered user
}

func (x *RegiterResponse) Reset() {
	*x = RegiterResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegiterResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegiterResponse) ProtoMessage() {}

func (x *RegiterResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegiterResponse.ProtoReflect.Descriptor instead.
func (*RegiterResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{1}
}

func (x *RegiterResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x2a, 0x0a, 0x0f, 0x52, 0x65,
	0x67, 0x69, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x17, 0x0a,
	...
	0xaa, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x38, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x61, 0x75,
	0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x67, 0x6c, 0x6f, 0x74, 0x6f, 0x76, 0x73, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
...
var file_sso_sso_proto_goTypes = []interface{}{
	...
	(*RegiterResponse)(nil), // 1: auth.RegiterResponse
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	1, // 3: auth.Auth.Register:output_type -> auth.RegiterResponse
