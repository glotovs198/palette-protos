...
type AuthClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegiterResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegiterResponse, error) {
	out := new(RegiterResponse)
...
type AuthServer interface {
	Register(context.Context, *RegisterRequest) (*RegiterResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRequest) (*RegiterResponse, error) {
